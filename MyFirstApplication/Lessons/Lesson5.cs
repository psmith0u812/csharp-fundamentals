...
internal class Lesson5
{
    ...
    /*
     Lambda using the Function Delagate
     */
    ...
    // Relational Pattern compares an expression resultwith a constant
    ...
    /*
     Logical Pattern OR mathes an expression when either pattern
